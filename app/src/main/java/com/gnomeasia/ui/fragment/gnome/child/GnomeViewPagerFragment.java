...
public class GnomeViewPagerFragment extends SupportFragment {
    ...
    private void initView(View view) {
        ...
        mViewPager.setAdapter(new PagerFragmentAdapter(getChildFragmentManager(),
                getString(R.string.toolbar_event), getString(R.string.toolbar_event), getString(R.string.toolbar_event), getString(R.string.toolbar_event), getString(R.string.toolbar_event), getString(R.string.toolbar_event)));
